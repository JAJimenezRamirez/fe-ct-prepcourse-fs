...
function agregarNumeros(arrayOfNums) {
   ...
   // Tu código:
   var suma = 0;
   for(var i = 0; i < arrayOfNums.length[1];)
      return suma;
}
...
function mesesDelAño(array) {
   ...
   if (mesesEncontrados.lenth === 3) {
      return mesesEncontrados;
   } else {
      return 'no se encontaron lose meses pedidos';
   }
}
